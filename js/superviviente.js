var superviviente={
    ...
    generar: function(){
        ...
        profesiones=["Cuidador","Policia","Cazador","Vagabundo","Escritor","Profesor","Conserje","Ladr&oacute;n","Banquero","Asesor","Estudiante","Inversor","Cocinero",,"Investigador","Detective","Barrendero","L&iacute;der de secta","M&uacute;sico","Pintor","Soldador","Jardinero","Electricista"];
        gr=Math.random();
        if(gr<=0.5){
