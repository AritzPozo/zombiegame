var superviviente={
    ...
    generar: function(){
        ...
        profesiones=["Cuidador","Policia","Cazador","Vagabundo","Escritor","Profesor","Conserje","Ladr&oacute;n","Banquero","Asesor","Estudiante","Jubilado","Investigador","Detective","Barrendero","L&iacute;der de secta","M&uacute;sico","Pintor","Soldador","Jardinero","Electricista"];
        gr=Math.random();
        if(gr<=0.5){
            genre=1;
    ...
    dibujarpj: function(){
        ...
        for(sz=0;sz<game.supervivientes.length;sz++){
            ...
            "<div style='height:20px;'><div style='float:left;width:50%'>"+game.supervivientes[sz].profesion+"</div><div style='float:left;width:50%;color:red;text-align:right'>";
