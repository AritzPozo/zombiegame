var superviviente={
    ...
    generar: function(){
        ...
        setTimeout(function(){
            sz=game.supervivientes.length-1;
            jcnt="<div class='pjbox' id='selpj"+sz+"' onclick='game.selectPj("+sz+")' style='opacity:0'>"+
            "<div class='pjimg'></div>"+
            "<div class='pjdatos'>"+
            ...
            for(ipj=0;ipj<game.supervivientes[sz].vidaAct;ipj++){
                jcnt=jcnt+'<i id="vidaAct '+ sz +'-'+ ipj +'" class="fa fa-heart" aria-hidden="true"></i> ';
            }
            local=game.supervivientes[sz].posicion;         
            
            jcnt=jcnt+"</div></div>"+
            "<div style='height:20px;'><div style='float:left;width:50%'><span id='pjidloc"+sz+"'>campamento</span></div><div style='float:left;width:50%;color:grey;text-align:right'>";
            for(ipj=0;ipj<game.supervivientes[sz].hambre;ipj++){
                jcnt=jcnt+'<i id="hambreAct '+ sz +'-'+ ipj +'" class="fa fa-cutlery" aria-hidden="true"></i> ';
            }            
